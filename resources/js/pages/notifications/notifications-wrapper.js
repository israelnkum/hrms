                        ...
                        <MenuHelper direction={'inline'}
                                    menus={[
                                        ...
                                        },
                                        {
                                            ...
                                            link: '/notifications/info-update',
                                            children: [
                                                {
                                                    title: `Pending (${notificationNavs.info_updates.pending ?? 0})`,
                                                    link: '/notifications/info-update/pending',
                                                    icon: 'home',
                                                    modal: false,
                                                    permission: ''
                                                },
                                                {
                                                    title: `Approved (${notificationNavs.info_updates.approved ?? 0})`,
                                                    link: '/notifications/info-update/approved',
                                                    icon: 'home',
                                                    modal: false,
                                                    permission: ''
                                                },
                                                {
                                                    title: `Rejected (${notificationNavs.info_updates.rejected ?? 0})`,
                                                    link: '/notifications/info-update/rejected',
                                                    icon: 'home',
                                                    modal: false,
                                                    permission: ''
                                                }
